...
Visit a live version of the site: https://robbatchcoder.github.io/Millionaire-Quiz/
## Contents
...
## 5. Wireframe 
Figma was used to generate the wireframe.
![Wireframe image](assets/images/millionaire-wireframe.png)

# Design
## Colour Scheme
The palette was generated by using the eye dropper extension from chrome to select colours from the millionaire logo.
![Palette image](assets/images/millionaire-palette.png)

## Logo
The game uses the logo from the popular TV show "Who want to be a millionaire".
![Logo image](assets/images/millionaire-logo.webp)
